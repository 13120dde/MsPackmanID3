...
public class DataTuple {
	...
	public enum DiscreteTag {
		...
		//TODO make unique enums for all elements
		//Column name - values
		POWER_PILL_DISTANCE, PP_VERY_LOW, PP_LOW, PP_MEDIUM, PP_HIGH, PP_VERY_HIGH,
		DIRECTION_TO_POWER_PILL, POWER_PILL_UP, POWER_PILL_DOWN, POWER_PILL_LEFT, POWER_PILL_RIGHT,

		PILL_DISTANCE, P_VERY_LOW, P_LOW, P_MEDIUM, P_HIGH, P_VERY_HIGH,
		DIRECTION_TO_PILL, PILL_UP, PILL_DOWN, PILL_LEFT, PILL_RIGHT,

		BLINKY_DISTANCE, BLINKY_VERY_LOW, BLINKY_LOW, BLINKY_MEDIUM, BLINKY_HIGH, BLINKY_VERY_HIGH, BLINKY_NONE,
		BLINKY_DIRECTION, BLINKY_MOVE_UP, BLINKY_MOVE_DOWN, BLINKY_MOVE_NEUTRAL, BLINKY_MOVE_LEFT, BLINKY_MOVE_RIGHT,
		BLINKY_EDIBLE, BLINKY_EDIBLE_TRUE, BLINKY_EDIBLE_FALSE,

		PINKY_DISTANCE, PINKY_VERY_LOW, PINKY_LOW, PINKY_MEDIUM, PINKY_HIGH, PINKY_VERY_HIGH, PINKY_NONE,
		PINKY_DIRECTION, PINKY_MOVE_UP, PINKY_MOVE_DOWN, PINKY_MOVE_NEUTRAL, PINKY_MOVE_LEFT, PINKY_MOVE_RIGHT,
		PINKY_EDIBLE, PINKY_EDIBLE_TRUE, PINKY_EDIBLE_FALSE,

		INKY_DISTANCE, INKY_VERY_LOW, INKY_LOW, INKY_MEDIUM, INKY_HIGH, INKY_VERY_HIGH, INKY_NONE,
		INKY_DIRECTION, INKY_MOVE_UP, INKY_MOVE_DOWN, INKY_MOVE_NEUTRAL, INKY_MOVE_LEFT, INKY_MOVE_RIGHT,
		INKY_EDIBLE, INKY_EDIBLE_TRUE, INKY_EDIBLE_FALSE,

		SUE_DISTANCE, SUE_VERY_LOW, SUE_LOW, SUE_MEDIUM, SUE_HIGH, SUE_VERY_HIGH,SUE_NONE,
		SUE_DIRECTION, SUE_MOVE_UP, SUE_MOVE_DOWN, SUE_MOVE_NEUTRAL, SUE_MOVE_LEFT, SUE_MOVE_RIGHT,
		SUE_EDIBLE, SUE_EDIBLE_TRUE, SUE_EDIBLE_FALSE,

		CLOSEST_GHOST_DISTANCE , CG_VERY_LOW, CG_LOW, CG_MEDIUM, CG_HIGH, CG_VERY_HIGH, CC_NONE,
		CLOSEST_GHOST_DIRECTION, CG_MOVE_UP, CG_MOVE_DOWN, CG_MOVE_NEUTRAL, CG_MOVE_LEFT, CG_MOVE_RIGHT,
		CLOSEST_GHOST_EDIBLE, CG_EDIBLE_TRUE, CG_EDIBLE_FALSE,

		CLASS, CLASS_LEFT, CLASS_UP, CLASS_DOWN, CLASS_RIGHT,


		//TESTVALS
		AGE,INCOME,STUDENT,CREDIT_RATING, CLASS_BUYS_COMPUTER, YOUTH,MIDDLE_AGED, SENIOR,S_NO,S_YES,C_NO,C_YES, EXCELLENT, FAIR;
