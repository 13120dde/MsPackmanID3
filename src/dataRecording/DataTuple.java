...
public class DataTuple {
	...
	public enum DiscreteTag {
		...
		PILL_DISTANCE,
		DIRECTION_TO_PILL, TO_PILL_UP, TO_PILL_DOWN, TO_PILL_LEFT, TO_PILL_RIGHT,
		...
		CLOSEST_GHOST_DIRECTION, GHOST_MOVE_UP, GHOST_MOVE_DOWN, GHOST_MOVE_NEUTRAL, GHOST_MOVE_LEFT, GHOST_MOVE_RIGHT,
		CLOSEST_GHOST_EDIBLE, EDIBLE_TRUE, EDIBLE_FALSE,
